...
- `get_job_run_error`: Retrieves error details for failed job runs to help troubleshoot errors (includes the option to return warning and deprecation details)
